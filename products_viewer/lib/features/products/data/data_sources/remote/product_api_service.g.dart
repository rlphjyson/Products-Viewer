...
class _ProductsApiService implements ProductsApiService {
  ...
  Future<HttpResponse<List<ProductListModel>>> getProductsList({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<List<ProductListModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    List<ProductListModel> _value = _result.data!['products']
  ...
  @override
  Future<HttpResponse<ProductModel>> getSingleProduct({int? id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
